...
func TestQueryHistoryStaking(t *testing.T) {
	...
	key := types.GetDelegationKey(addr, addr)
	req := abci.RequestQuery{
		Path:   fmt.Sprintf("store/%s/%s/key", "0x3F43E75Aaba2c2fD6E227C10C6E7DC125A93DE3c", "staking"),
		Height: height,
		Data:   key,
		Prove:  true,
	}
