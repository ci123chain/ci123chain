...
var (
	...
	// ErrInternal define an error when
	ErrInternalStack = Register(RootCodespace, 40, "Internal Stack error")

	///ErrParams
	ErrParams = Register(RootCodespace, 41, "invalid params")

	///ErrInternal
	ErrInternal = Register(RootCodespace, 42, "Internal error")
