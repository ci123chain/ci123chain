...
func TestNewUInt64Coin(t *testing.T) {
	...
	c := NewUInt64Coin(ChainCoinDenom, 100)
...
func TestCoin_Add(t *testing.T) {
	...
	c1 := NewUInt64Coin(ChainCoinDenom, 100)
	c2 := NewUInt64Coin(ChainCoinDenom,200)
	c := c1.Add(c2)
	require.Equal(t, NewUInt64Coin(ChainCoinDenom, 300), c)
}

func TestCoin_Sub(t *testing.T) {

	c1 := NewUInt64Coin(ChainCoinDenom, 200)
	c2 := NewUInt64Coin(ChainCoinDenom, 100)
	c := c1.Sub(c2)
	require.Equal(t, NewUInt64Coin(ChainCoinDenom,100), c)

	c3 := NewUInt64Coin(ChainCoinDenom,100)
	c4 := NewUInt64Coin(ChainCoinDenom,200)
	c = c3.Sub(c4) //panic

	c5 := NewUInt64Coin(ChainCoinDenom,100)
	c6 := NewUInt64Coin(ChainCoinDenom,100)
	c = c5.Sub(c6)
	require.Equal(t, NewUInt64Coin(ChainCoinDenom,0), c)
}
