...
var _ relayPacket = &relayMsgRecvPacket{}
var _ relayPacket = &relayMsgPacketAck{}
var _ relayPacket = &relayMsgTimeout{}
...
func (rp *relayMsgTimeout) FetchCommitResponse(src, dst *Chain) (err error) {
	panic("relayMsgTimeout.FetchCommitResponse not used")
...
func (rp *relayMsgTimeout) Msg(src, dst *Chain) (sdk.Msg, error) {
	panic("relayMsgTimeout.Msg not used")
...
func (r relayMsgRecvPacket) Data() []byte {
	return r.packetData}

func (r relayMsgRecvPacket) Seq() uint64 {
	return r.seq
}

func (r relayMsgRecvPacket) Timeout() clienttypes.Height {
	return r.timeout
}
