...
func registerTxRoutes(cliCtx context.Context, r *mux.Router)  {
	...
	r.HandleFunc("/vm/contract/evmupload", rest.MiddleHandler(cliCtx, upuploadContractHandler, evmtypes.DefaultCodespace)).Methods("POST")
	r.HandleFunc("/vm/contract/evmexecute", rest.MiddleHandler(cliCtx, exexcuteContractHandler, evmtypes.DefaultCodespace)).Methods("POST")
}
