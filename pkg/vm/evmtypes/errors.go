...
func ErrComputeGas(codespce sdk.CodespaceType, msg string) sdk.Error {
	return sdk.NewError(codespce, CodeComputeGasFailedError, msg)
}

func ErrInvalidState(codespce sdk.CodespaceType, msg string) sdk.Error {
	return sdk.NewError(codespce, CodeErrInvalidState, msg)
}
