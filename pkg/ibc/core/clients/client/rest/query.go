...
import (
	...
	"github.com/ci123chain/ci123chain/pkg/ibc/core/clients/utils"
...
func RegisterQueryRoutes(cliCtx context.Context, r *mux.Router) {
	// Get all validators
	r.HandleFunc("/ibc/clients", queryClients(cliCtx)).Methods("POST")
	// Get a single validator info
}

func queryClients(cliCtx context.Context) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		resp, err := utils.QueryClientStatesABCI(cliCtx, 0, 1000)
		if err != nil {
