...
func InitGenesis(ctx sdk.Context, keeper keeper.Keeper, stakingKeeper staking.StakingKeeper, data *types.GenesisState) {
	...
	for _, array := range data.MissedBlocks {
		address, err := sdk.AccAddressFromBech32(array.Address)
		if err != nil {
			panic(err)
		}
...
func ExportGenesis(ctx sdk.Context, keeper keeper.Keeper) (data *types.GenesisState) {
	...
	keeper.IterateValidatorSigningInfos(ctx, func(address sdk.AccAddress, info types.ValidatorSigningInfo) (stop bool) {
