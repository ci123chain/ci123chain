...
//// transaction.
//func NewUnjailRequestHandlerFn(clientCtx context.Context) http.HandlerFunc {
//	return func(w http.ResponseWriter, r *http.Request) {
//		vars := mux.Vars(r)
//		bech32Validator := vars["validatorAddr"]
//
//		var req UnjailReq
//		if !rest.ReadRESTReq(w, r, clientCtx.Cdc, &req) {
//			return
//		}
//
...
//		}
//
//		valAddr, err := sdk.AccAddressFromBech32(bech32Validator)
