...
//func registerQueryRoutes(clientCtx context.Context, r *mux.Router) {
//	r.HandleFunc(
...
//func signingInfoHandlerFn(clientCtx context.Context) http.HandlerFunc {
...
//		}
//
//		params := slashing.QuerySigningInfoRequest{ConsAddress: pk.Address().String()}
//
