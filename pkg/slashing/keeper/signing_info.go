...
// ConsAddress
func (k Keeper) GetValidatorSigningInfo(ctx sdk.Context, address sdk.AccAddress) (info types.ValidatorSigningInfo, found bool) {
...
// persited.
func (k Keeper) HasValidatorSigningInfo(ctx sdk.Context, consAddr sdk.AccAddress) bool {
...
func (k Keeper) SetValidatorSigningInfo(ctx sdk.Context, address sdk.AccAddress, info types.ValidatorSigningInfo) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) IterateValidatorSigningInfos(ctx sdk.Context,
	handler func(address sdk.AccAddress, info types.ValidatorSigningInfo) (stop bool)) {
...
func (k Keeper) GetValidatorMissedBlockBitArray(ctx sdk.Context, address sdk.AccAddress, index int64) bool {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) IterateValidatorMissedBlockBitArray(ctx sdk.Context,
	address sdk.AccAddress, handler func(index int64, missed bool) (stop bool)) {
...
func (k Keeper) GetValidatorMissedBlocks(ctx sdk.Context, address sdk.AccAddress) []types.MissedBlock {
...
func (k Keeper) JailUntil(ctx sdk.Context, consAddr sdk.AccAddress, jailTime time.Time) {
...
func (k Keeper) Tombstone(ctx sdk.Context, consAddr sdk.AccAddress) {
	signInfo, ok := k.GetValidatorSigningInfo(ctx, consAddr)
	if !ok {
...
func (k Keeper) IsTombstoned(ctx sdk.Context, consAddr sdk.AccAddress) bool {
	signInfo, ok := k.GetValidatorSigningInfo(ctx, consAddr)
	if !ok {
		return false
	}
...
func (k Keeper) clearValidatorMissedBlockBitArray(ctx sdk.Context, address sdk.AccAddress) {
	store := ctx.KVStore(k.storeKey)
