...
func querySigningInfo(ctx sdk.Context, req abci.RequestQuery, k Keeper, legacyQuerierCdc *codec.Codec) ([]byte, error) {
	...
	signingInfo, found := k.GetValidatorSigningInfo(ctx, sdk.HexToAddress(params.ConsAddress))
	if !found {
...
func querySigningInfos(ctx sdk.Context, req abci.RequestQuery, k Keeper, legacyQuerierCdc *codec.Codec) ([]byte, error) {
	...
	k.IterateValidatorSigningInfos(ctx, func(consAddr sdk.AccAddress, info types.ValidatorSigningInfo) (stop bool) {
