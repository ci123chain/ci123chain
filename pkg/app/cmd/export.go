		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if exported.ConsensusParams != nil {
				...
				if exported.ConsensusParams.Evidence != nil {
					...
					evidence.MaxBytes = 100000
					evidence.MaxAgeDuration = 172800000000000
					evidence.MaxAgeNumBlocks = 1048576
				}
			...
			_ = ioutil.WriteFile(filepath.Join(homeDir, "logs/genesis.json"), encoded, 0755)
