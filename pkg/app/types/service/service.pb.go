...
// source: weelink/app/service/service.proto
...
import (
	context "context"
	fmt "fmt"
	types "github.com/ci123chain/ci123chain/pkg/abci/types"
...
func (*SimulateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_de5b0e7de61a264a, []int{0}
}
...
func (*SimulateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_de5b0e7de61a264a, []int{1}
}
...
func init() {
	proto.RegisterType((*SimulateRequest)(nil), "weelink.app.SimulateRequest")
	golang_proto.RegisterType((*SimulateRequest)(nil), "weelink.app.SimulateRequest")
	proto.RegisterType((*SimulateResponse)(nil), "weelink.app.SimulateResponse")
	golang_proto.RegisterType((*SimulateResponse)(nil), "weelink.app.SimulateResponse")
}

func init() { proto.RegisterFile("weelink/app/service/service.proto", fileDescriptor_de5b0e7de61a264a) }
func init() {
	golang_proto.RegisterFile("weelink/app/service/service.proto", fileDescriptor_de5b0e7de61a264a)
}

var fileDescriptor_de5b0e7de61a264a = []byte{
	// 310 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *serviceClient) Simulate(ctx context.Context, in *SimulateRequest, opts ...grpc.CallOption) (*SimulateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/weelink.app.Service/Simulate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Simulate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/weelink.app.Service/Simulate",
	}
...
var _Service_serviceDesc = grpc.ServiceDesc{
	ServiceName: "weelink.app.Service",
	...
	Metadata: "weelink/app/service/service.proto",
}
