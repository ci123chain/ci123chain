...
func NewKeeper(skipUpgradeHeights map[int64]bool, storeKey sdk.StoreKey, cdc *codec.Codec, gravityKeeper gravity.Keeper) Keeper {
	...
	k.SetUpgradeHandler("UpgradeV1.6.43", func(ctx sdk.Context, info []byte) {
		k.GravityKeeper.Reset(ctx)
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.43")
	})
	k.SetUpgradeHandler("UpgradeV1.6.45", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.45")
	})
	k.SetUpgradeHandler("UpgradeV1.6.46", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.46")
	})
	k.SetUpgradeHandler("UpgradeV1.6.47", func(ctx sdk.Context, info []byte) {
		k.GravityKeeper.Reset(ctx)
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.47")
	})
	k.SetUpgradeHandler("UpgradeV1.6.48", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.48")
	})
	k.SetUpgradeHandler("UpgradeV1.6.51", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.51")
	})
	k.SetUpgradeHandler("UpgradeV1.6.52", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.52")
	})
	k.SetUpgradeHandler("UpgradeV1.6.53", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.6.53")
	})
	...
	k.SetUpgradeHandler("UpgradeV1.7.3", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.7.3")
	})
	k.SetUpgradeHandler("UpgradeV1.7.5", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.7.5")
	})
	k.SetUpgradeHandler("UpgradeV1.7.6", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade successful:", "proposal", "upgrade v1.7.6")
	})
	k.SetUpgradeHandler("UpgradeV1.7.7", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade miner successful:", "proposal", "upgrade v1.7.7")
	})
	k.SetUpgradeHandler("UpgradeV1.7.8", func(ctx sdk.Context, info []byte) {
		k.Logger(ctx).Info("Upgrade ws write successful:", "proposal", "upgrade v1.7.8")
	})
	return k
}
