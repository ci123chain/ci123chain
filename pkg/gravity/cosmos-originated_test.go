...
import (
	...
	bank "github.com/ci123chain/ci123chain/pkg/bank/types"
...
func initializeTestingVars(t *testing.T) *testingVars {
	...
	tv.myValAddr = sdk.AccAddress(tv.myOrchestratorAddr) // revisit when proper mapping is impl in keeper
