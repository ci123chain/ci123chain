...
import (
	"github.com/ci123chain/ci123chain/proto/slashing"
	"time"

	sdk "github.com/ci123chain/ci123chain/pkg/abci/types"
	bank "github.com/ci123chain/ci123chain/pkg/account/types"
...
type StakingKeeper interface {
	...
	GetLastValidatorPower(ctx sdk.Context, operator sdk.AccAddress) int64
	...
	GetValidator(ctx sdk.Context, addr sdk.AccAddress) (validator stakingtypes.Validator, found bool)
	...
	Validator(sdk.Context, sdk.AccAddress) stakingtypes.ValidatorI
	ValidatorByConsAddr(sdk.Context, sdk.AccAddress) stakingtypes.ValidatorI
	Slash(sdk.Context, sdk.AccAddress, int64, int64, sdk.Dec)
	Jail(sdk.Context, sdk.AccAddress)
}
...
type SlashingKeeper interface {
	GetValidatorSigningInfo(ctx sdk.Context, address sdk.AccAddress) (info slashing.ValidatorSigningInfo, found bool)
}
