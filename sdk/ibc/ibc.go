...
func SignIBCTransferMsg(from string, to string, amount, gas uint64, priv []byte, nonce uint64) ([]byte, error) {
...
func buildIBCTransferMsg (from, to string, amount, gas uint64, nonce uint64) (transaction.Transaction, error) {
