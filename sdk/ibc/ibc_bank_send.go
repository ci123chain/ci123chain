...
func SignIBCBankSendMsg(from string, raw []byte, gas uint64, priv []byte, nonce uint64) ([]byte, error) {
...
func buildIBCBankSendMsg (from string, raw []byte, gas uint64, nonce uint64) (transaction.Transaction, error) {
