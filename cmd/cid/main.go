...
const (
	...
	logINFO      = "x/order:info,x/upgrade:info,x/registry:info,p2p:info,state:debug,x/staking:info,x/preStaking:info,x/ibc/client:info,x/ibc/connection:info,x/ibc/channel:info,x/gravity:info,x/supply:info,*:error"
	logDEBUG      = "*:debug"
	//logINFO      = "*:info"
	logERROR     = "*:error"
	logNONE      = "*:none"
