...
if [ ! -f $CI_HOME/config/genesis.json ]; then
    if [ $CI_CONFIG ]; then
      ...
      /opt/cid-linux add-genesis-account 0x204bCC42559Faf6DFE1485208F7951aaD800B313 1000000000000000000000 --home=$CI_HOME
      # a78a8a281d160847f1ed7881e5497e1a98ccd4fe6ba9ce918630f93a44e09793
      /opt/cid-linux add-genesis-account 0x3F43E75Aaba2c2fD6E227C10C6E7DC125A93DE3c 1000000000000000000000 --home=$CI_HOME
