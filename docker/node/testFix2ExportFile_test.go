...
func TestFix2File(t *testing.T) {
	...
	exportFile, err := types.GenesisDocFromFile("/Users/tanhui/Downloads/genesis/genesis.json")
	if err != nil {
		t.Log(err)
	}
	...
	//fix gravity
	//var oldGraGenesisState gravity_types.GenesisState
	//cdc.MustUnmarshalJSON(genesisState["gravity"], &oldGraGenesisState)
	//
	genesisStateRaw["gravity"] = genesisState["gravity"]
